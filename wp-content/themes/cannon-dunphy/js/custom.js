...
$('.sidebar_wrapper ul.menu > li.menu-item-has-children > a').on('click', function(e) {
 ...
 $('.cr_select').on('click', function(e) {
 
 	$('.cr_select_dropdown').slideToggle(300);
 ...
 $(document).click(function (e){
		...
		var container = $(".cr_select.open");

		if (!container.is(e.target) && container.has(e.target).length === 0){

			$('.cr_select_dropdown').slideUp();
	...
	$('.cr_select_dropdown ul li').on('click', function(e) {
		...
		$('.single_case_results:not(.' + mydata + ')').fadeOut(300);
		
		$('.' + mydata + '').delay(500).fadeIn();
		
/*
		$('.single_case_results:not(.' + mydata + ')').addClass('hide');
		
		$('.' + mydata + '').removeClass('hide');
*/
